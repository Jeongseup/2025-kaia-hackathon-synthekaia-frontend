...
export const VaultTab = () => {
  ...
  const fetchVaultData = useCallback(async () => {
    if (!STKAIA_DELTA_NEUTRAL_VAULT_ADDRESS) return;
  ...
  // Calculate vault total value
  const calculateVaultValue = (status: VaultStatus) => {
    ...
    <div className={styles.container}>
      <div className={styles.vaultContent}>
        ...
        <div className={styles.strategySection}>
          <h4 className={styles.sectionTitle}>Strategy Information</h4>
          <div className={styles.strategyCard}>
            <div className={styles.strategyHeader}>
              <h5 className={styles.strategyTitle}>Delta Neutral Strategy</h5>
              <span className={styles.statusBadge}>Active</span>
            </div>
            <div className={styles.strategyDescription}>
              <p>This vault implements a delta-neutral strategy by holding stKAIA tokens while maintaining a short position in KAIA, effectively hedging against price movements while earning staking rewards.</p>
            </div>
            <div className={styles.strategyMetrics}>
              <div className={styles.metricRow}>
                <span className={styles.metricLabel}>Strategy Type:</span>
                <span className={styles.metricValue}>Delta Neutral</span>
              </div>
              <div className={styles.metricRow}>
                <span className={styles.metricLabel}>Risk Level:</span>
                <span className={styles.metricValue}>Low</span>
              </div>
              <div className={styles.metricRow}>
                <span className={styles.metricLabel}>Expected APY:</span>
                <span className={styles.metricValue}>~7.5%</span>
              </div>
            </div>
          </div>
        </div>
